"""
Django settings for djangoaquaint project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [
			'/home/ubuntu/djangoaquaint/users/templates/',
			'/home/ubuntu/djangoaquaint/index/templates/'
		],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'djangoaquaint.wsgi.application'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'djangoaquaint', 'static', 'static_root')
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "djangoaquaint", "static", "static_dirs")
]
