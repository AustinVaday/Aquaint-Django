"""
Custom Django Authentication Backend - Taken from: django_warrant/utils.py and backend.py
...
### Helper functions for Cognito (utils.py)
...
### Django authentication backend in Cognito (backend.py)
